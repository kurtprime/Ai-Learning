...
const searchParamsSchema = z.object({
  ...
  experience: z.enum(experienceLevel).optional().catch(undefined),
  ...
  jobIds: z
    .union([
      z.string(),
      z.array(z.string()).transform((v) => (Array.isArray(v) ? v : [v])),
    ])
    .optional()
    .catch([]),
});
  ...
  return (
    ...
    >
      ...
      <CardContent className="flex flex-wrap gap-2">
        <JoblistingBadges
          jobListing={jobListing}
          className={jobListing.isFeatured ? "border-primar/30" : undefined}
        />
      </CardContent>
    </Card>
  );
