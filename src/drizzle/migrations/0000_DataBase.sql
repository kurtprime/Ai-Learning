...
CREATE TYPE "public"."job_application_stage" AS ENUM('denied', 'applied', 'interested', 'interviewed', 'hired');--> statement-breakpoint
CREATE TABLE "users" (
...
CREATE TABLE "job_listing_applications" (
	...
	"coverLetter" text,
	"rating" integer,
	"stage" "job_application_stage" DEFAULT 'applied' NOT NULL,
	"createdAt" timestamp with time zone DEFAULT now() NOT NULL,
	"updatedAt" timestamp with time zone DEFAULT now() NOT NULL,
