...
export default function JobListingFilterForm() {
  ...
  const form = useForm({
    ...
    defaultValues: {
      ...
      stateAbbreviation: searchParams.get("stateAbbreviation") ?? "",
      experienceLevel:
        (searchParams.get("experience") as ExperienceLevel) ?? ANY_VALUE,
      type: (searchParams.get("title") as JobListingType) ?? ANY_VALUE,
      locationRequirement:
  ...
  async function onSubmit(data: z.infer<typeof jobListingFilterSchema>) {
          ...
          render={({ field }) => (
            <FormItem>
              ...
              >
                ...
                <SelectContent>
                  <SelectItem value={ANY_VALUE} className="w-full">
                    Any
                  </SelectItem>
