...
import { updateOrganizationUserSettings } from "../db/organizationUserSettings";

export async function updateOrganizationUserSetting(
  ...
  await updateOrganizationUserSettings(
    {
      userId,
