...
import RatingIcons from "@/features/jobListingApplication/components/RatingIcons";
import { RATING_OPTIONS } from "@/features/jobListingApplication/data/constants";
import LoadingSwap from "@/components/LoadingSwap";
import { updateOrganizationUserSetting } from "../actions/organizationUserSettingsActions";
...
export function NotificationsForm({
  ...
  async function onSubmit(
    ...
    const result = await updateOrganizationUserSetting(data);
